        # Metasprint Cardio Universe: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metasprint-cardio-universe.git

        ## Objective

        MetaSprint Cardio Universe is a cardiovascular evidence synthesis platform providing automated pooling across cardiology trial networks.
        ...
        - Code: https://github.com/mahmood726-cyber/metasprint-cardio-universe.git
        - Dashboard: https://mahmood726-cyber.github.io/metasprint-cardio-universe/
