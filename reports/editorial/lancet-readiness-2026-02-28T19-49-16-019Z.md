...
Generated: 2026-02-28T19:49:16.019Z
...
- PASS [critical] Advanced statistics and bias robustness suite
  target: pairwise=passed, bias=passed, ROB-ME coverage>=100%
  actual: pairwise=passed; bias=passed; ROB-ME coverage=100%
  evidence: `reports\benchmarks\pairwise-v2.json; reports\benchmarks\bias-sensitivity.json`
